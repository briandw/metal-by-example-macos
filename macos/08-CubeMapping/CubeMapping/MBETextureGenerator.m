                        ...
                        completionBlock:(void (^)(id<MTLTexture>))completionBlock
{
    ...
    while (mipWidth >= 1 && mipHeight >= 1)
    {
        ...
        NSColor *tintColor = [self tintColorAtIndex:level - 1];
...
+ (NSColor *)tintColorAtIndex:(size_t)index
{
    switch (index % 7) {
        case 0:
        ...
        case 5:
            return [NSColor colorWithRed:0.5 green:0.0 blue:1.0 alpha:1.0]; // indigo
        case 6:
        default:
